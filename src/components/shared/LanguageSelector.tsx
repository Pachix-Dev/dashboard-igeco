  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-2 rounded-md border border-white/30 bg-white/10 px-2 py-2 text-sm font-medium text-white backdrop-blur hover:bg-white/20 transition-all"
      >
