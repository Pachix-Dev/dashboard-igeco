            ...
            <div className="w-full max-w-3xl rounded-3xl border border-white/10 bg-gradient-to-br from-slate-900 via-slate-900 to-slate-950 p-8 shadow-2xl shadow-blue-500/20">
              ...
              <form onSubmit={handleSubmit(handleUser)} className="space-y-5">
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-semibold text-slate-200">{t('form.lastname')}</label>
                    <input
                      type="text"
                      name="lastname"
                      {...register('lastname', {
                    ...
                    />
                    {errors.lastname && (
                      <p className="text-sm text-rose-400">{errors.lastname.message}</p>
                    )}
                  </div>
                </div>
                ...
                <div className="grid gap-4 md:grid-cols-[2fr,1fr]">
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    {errors.position && (
                      <p className="text-sm text-rose-400">{errors.position.message}</p>
                    )}
                  </div>
                </div>

                <div className="space-y-2">
                  <label className="text-sm font-semibold text-slate-200">{t('form.nationality')}</label>
                  <select
                    name="nationality"
                  ...
                  {errors.nationality && (
                    <p className="text-sm text-rose-400">{errors.nationality.message}</p>
                  )}
                </div>
