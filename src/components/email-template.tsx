...
const translations = {
  es: {
    ...
    greeting: '¡Hola',
    accountCreated: 'Tu cuenta ha sido creada exitosamente. Ahora eres parte de la comunidad de IGECO y tienes acceso a nuestra plataforma de expositores para cargar tus gafetes, contratar app scanner para recolectar leads potenciales y más.',
  ...
  en: {
    ...
    greeting: 'Hello',
    accountCreated: 'Your account has been successfully created. You are now part of the IGECO community and have access to our exhibitor platform to upload your badges, hire the scanner app to collect potential leads, and more.',
  ...
  it: {
    ...
    greeting: 'Ciao',
    accountCreated: 'Il tuo account è stato creato con successo. Ora fai parte della comunità IGECO e hai accesso alla nostra piattaforma per espositori per caricare i tuoi badge, assumere l\'app scanner per raccogliere potenziali lead e altro ancora.',
