...
export async function POST(req: Request) {
  ...
  try {
    ...
    await db.query(
      'INSERT INTO ponentes (name, position, company, bio_esp, bio_eng, photo, linkedin, email, phone, uuid) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)',
      [name, position, company, bio_esp, bio_eng, photo, linkedin, email, phone, uuid]
    );
