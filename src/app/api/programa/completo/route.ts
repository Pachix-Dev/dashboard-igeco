  ...
  try {
    ...
    let query = `
      SELECT 
        ...
        pc.title_eng AS conferencia_title_eng,
        pc.description AS conferencia_description,
        pc.description_eng AS conferencia_description_eng,
        pc.start_time,
        pc.end_time,
        pc.room,
      ...
      if (row.dia_id) {
        ...
        if (row.conferencia_id) {
          const conferencia = {
            ...
            title_en: row.conferencia_title_eng,
            description: row.conferencia_description,
            description_en: row.conferencia_description_eng,
